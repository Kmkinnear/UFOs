...
The purpose of this project was to expand on our UFO tracking website that we created with Dana in the module. However, that website only allowed us to be able to filter our sightings data by "Date". We have now added more search criteria that will allow us the ability to filter by "City", "State", "Country", and "Shape". This will give the user an easier way to drill down into the specific data that they are looking for. 
